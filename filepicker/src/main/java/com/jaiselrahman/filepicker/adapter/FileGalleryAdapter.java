...
import com.jaiselrahman.filepicker.utils.EasyFile;
...
public class FileGalleryAdapter extends MultiSelectionAdapter<FileGalleryAdapter.ViewHolder>
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (mediaFile.getMediaType() == MediaFile.TYPE_VIDEO ||
            ...
            String extension = EasyFile.getExtension(mediaFile.getPath());

            holder.fileThumbnail.setPadding(15, 15, 15, 15);
            holder.fileThumbnail.setImageResource(EasyFile.getThumbnail(extension));
